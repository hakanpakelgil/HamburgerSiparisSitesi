...
namespace HamburgerMVC4.Data.Migrations
{
    ...
    [Migration("20240213120910_seventh")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HamburgerMVC4.Data.User", b =>
                {
            ...
            modelBuilder.Entity("HamburgerMVC4.Data.Order", b =>
                {
                    b.HasOne("HamburgerMVC4.Data.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HamburgerMVC4.Data.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
